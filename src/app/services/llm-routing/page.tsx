...
const features = [
  {
    ...
    description:
      "Automatically route your request to the best LLM based on availability, cost, and performance.",
  },
  {
    icon: "⚡",
    title: "Low Latency",
    description:
      "Optimized routing ensures your responses are delivered faster with minimal wait time.",
  },
  {
    icon: "🔒",
    title: "Secure & Reliable",
    description:
      "All requests are encrypted and handled securely, ensuring privacy and integrity.",
  },
];
    ...
    <div className="bg-black min-h-screen px-6 py-12 text-white">
      ...
      <section className="mt-24 max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400 mb-8">
          LLM Routing connects your application to multiple large language models,
          intelligently choosing the best model based on latency, cost, and accuracy.
        </p>
        <motion.div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
          {["Step 1: Send your request", "Step 2: Routing Engine selects model", "Step 3: Receive optimized response", "Step 4: Logs & analytics"].map(
            (step, idx) => (
              <motion.div
                key={idx}
                whileHover={{ scale: 1.05 }}
